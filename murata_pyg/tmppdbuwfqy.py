...
class Propagate_1d6abc(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_1d6abc(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_1d6abc(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_1d6abc) -> Collect_1d6abc
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_1d6abc) -> Collect_1d6abc
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_1d6abc(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_1d6abc(x=x, edge_weight=edge_weight)
