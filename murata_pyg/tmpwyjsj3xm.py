...
class Propagate_08fafa(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_08fafa(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_08fafa(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_08fafa) -> Collect_08fafa
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_08fafa) -> Collect_08fafa
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_08fafa(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_08fafa(x=x, edge_weight=edge_weight)
