...
ls /data/suehara/mldata/pfa/murata/data/raw/fixed_uds/uu/500GeV/*.h5 | nl -v0 | xargs -n2 -P4 bash run_root_parallel_0.sh
ls /data/suehara/mldata/pfa/murata/data/raw/fixed_uds/dd/500GeV/*.h5 | nl -v0 | xargs -n2 -P4 bash run_root_parallel_0.sh
ls /data/suehara/mldata/pfa/murata/data/raw/fixed_uds/ss/500GeV/*.h5 | nl -v0 | xargs -n2 -P4 bash run_root_parallel_0.sh
