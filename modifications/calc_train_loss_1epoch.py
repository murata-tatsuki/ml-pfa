...
def main():
    ...
    parser.add_argument('--epoch-specific', type=int)
    ...
    input_dim = 7
    # output_dim = 9
    # ckpt_dir = "/home/murata/master/checkpoint/output_dimensions/ckpts_gravnet_new02_Jun27_1419_D9/"
    output_dim = 17
    ckpt_dir = "/home/murata/master/checkpoint/output_dimensions/ckpts_gravnet_new02_Jun27_1426_D17/"
    ...
    ckpt = ckpt_dir + "ckpt_" + str(i_epoch) + "_1.pth.tar"
