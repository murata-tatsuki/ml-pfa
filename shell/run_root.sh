...
############## 
# usage 
# python save_root.py ${test sample path} ${checkpoint path}/ckpt_${epoch}_1.pth.tar ${output_path}/${outfile} ${initial event number} ${last event number} ${timingCu} ${total input dimension} ${total output dimension} (options...)
##############
