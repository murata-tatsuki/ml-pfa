...
testDir=/data/suehara/mldata/pfa/ntau/tc_ntau_10GeV_10/test
ckp=/home/murata/master/checkpoint/energy_regression

## scan tbeta (0.0-0.9, 0.1 increment) and td (0.1-0.9, 0.1 increment) D=5 energy-regression momentum-input
# python save_root_tbeta_td_scan_energyRegression.py ${testDir} ${ckp}/ckpts_gravnet_new02_2024_11_12_163532_outputD5/ckpt_49_1.pth.tar output/energy_regression/new_clustering/energyTree/tbeta_td/restartPeriod50 0 50000 False 7 6 False True True False
# python save_root_tbeta_td_scan_energyRegression.py ${testDir} ${ckp}/ckpts_gravnet_new02_2024_11_13_165313_outputD5/ckpt_49_1.pth.tar output/energy_regression/new_clustering/energyTree/tbeta_td/restartPeriod30 0 50000 False 7 6 False True True False
...
# python save_root_tbeta_td_scan_reversed.py /data/suehara/mldata/pfa/murata/skimmed/ntau_10GeV_10/test /home/murata/master/checkpoint/output_dimensions/ckpts_gravnet_new02_2024_08_16_165355_outputD5_skimmed/ckpt_49_1.pth.tar output/skimmed/new_clustering/hyper_parameter/tbeta_td/ntau/reverse 0 500000 False 7 5 False
# jet
# python save_root_tbeta_td_scan.py /data/suehara/mldata/pfa/murata/skimmed/uds91/test /home/murata/master/checkpoint/output_dimensions/ckpts_gravnet_new02_2024_10_05_071011_outputD5_skimmed/ckpt_49_1.pth.tar output/skimmed/new_clustering/hyper_parameter/tbeta_td/uds/tbeta010td010 0 500000 False 7 5 False
# python save_root_tbeta_td_scan_reversed.py /data/suehara/mldata/pfa/murata/skimmed/uds91/test /home/murata/master/checkpoint/output_dimensions/ckpts_gravnet_new02_2024_10_05_071011_outputD5_skimmed/ckpt_49_1.pth.tar output/skimmed/new_clustering/hyper_parameter/tbeta_td/uds/reverse 0 500000 False 7 5 False
