...
python save_root.py ${test_path} ${cp_path[${D}]}/ckpt_49_1.pth.tar ${output_path}/test.root 0 500000 False 7 ${D} False
...
#   cp_path[$D]=""
#   cp_path[5]=${checkpoint_path}/checkpoint/energy_regression/ckpts_gravnet_new02_2024_08_21_134147_outputD5
#   if [ "${energy_regression_betaMSE}" ]; then
#     cp_path[5]=${checkpoint_path}/checkpoint/energy_regression/ckpts_gravnet_new02_2024_08_22_123039_outputD5
#   fi
# fi
# python save_root.py ${test_path} ${cp_path[${D}]}/ckpt_49_1.pth.tar ${output_path}/tc_${train_particle}_${D}D_49_${test_particle}.root 0 500000 False 8 ${D} False
