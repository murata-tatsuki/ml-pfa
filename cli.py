...
def build_train_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--thetaphi', action='store_true', default=True, help='Input theta and phi made from px, py, pz')
    ...
    parser.add_argument('--beta-track', action='store_true', default=True, help='Include L_beta_track term')
    parser.add_argument('--beta-track-beginning', action='store_true', help='L_beta_track term from epoch 1')
    parser.add_argument('--force-track-alpha', action='store_true', default=True, help='Force track as alpha (condensation point)')
    ...
    parser.add_argument('--output-dimension', type=int, default=5, help='Specify total output dimension (note that 1 dim each is used for beta and charged cluster loss)')
    ...
    parser.add_argument('--energy-regression', dest='energy_regression', , action='store_true', help='Turn on energy regression term on loss function and output')
    parser.add_argument('--no-energy-regression', dest='energy_regression', action='store_false', help='Turn off energy regression term on loss function and output')
    parser.set_defaults(energy_regression=True)
    ...
    parser.add_argument('--energy-regression-cluster', dest='energy_regression_cluster', , action='store_true', help='Turn on energy regression term on loss function and output (cluster energy for neutral particles)')
    parser.add_argument('--no-energy-regression-cluster', dest='energy_regression_cluster', action='store_false', help='Turn off energy regression term on loss function and output (cluster energy for neutral particles)')
    parser.set_defaults(energy_regression_cluster=True)
    parser.add_argument('--regression-coefficinet', type=float, default=1)                       ### energy regression scaling factor
    parser.add_argument('--LE-track', type=str, default='alpha_tracker_diff_log_perCluster', help='Specify L_E_track loss term')
    parser.add_argument('--LE-cluster', type=str, default='sum_log_perCluster', help='Specify L_E_cluster loss term')
    ...
    parser.add_argument('--momentum', action='store_true', default=True, help='Add momentum to GNN input')
    parser.add_argument('--momentum-amp', action='store_true', default=True, help='Add absoute momentum to GNN input')
    ...
    parser.add_argument('--qmin', type=float, default=0.2, help='')
    ...
    parser.add_argument('--lr-policy', type=str, default='cosineReduce', help='Specify lraning rate policy at lrscheduler.py')
    ...
    parser.add_argument('--clip-value', type=int, default=10, help='threshold of gradient clipping')
