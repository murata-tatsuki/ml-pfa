...
## uds skimmed
# python train.py -i /data/suehara/mldata/pfa/murata/skimmed/uds91/train -ii /data/suehara/mldata/pfa/murata/skimmed/uds91/validation --no-split --thetaphi --cuda cuda:${ncuda} --epochs 50 --beta-track --force-track-alpha --batch-size 5 --output-dimension ${outputD} --ckptdir checkpoint/output_dimensions/ckpts_gravnet_new02_${DATE}_outputD${outputD}_skimmed > log/output_dimension/tc_uds91_timingcut_forcealpha_thetaphi_outputD${outputD}_${DATE}_skimmed.log
