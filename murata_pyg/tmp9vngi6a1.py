...
class Propagate_1d741d(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_1d741d(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_1d741d(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_1d741d) -> Collect_1d741d
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_1d741d) -> Collect_1d741d
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_1d741d(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_1d741d(x=x, edge_weight=edge_weight)
