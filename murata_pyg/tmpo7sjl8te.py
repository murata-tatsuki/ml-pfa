...
class Propagate_08e78e(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_08e78e(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_08e78e(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_08e78e) -> Collect_08e78e
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_08e78e) -> Collect_08e78e
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_08e78e(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_08e78e(x=x, edge_weight=edge_weight)
