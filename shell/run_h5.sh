...
python save_pred.py h5/ntau_10GeV_10_pandora/test checkpoint/ckpts_gravnet_new02_Apr23_1328/ckpt_49_1.pth.tar h5/outfile_display_pandora_ntau.h5 0 1 0 7 3 0 True > log/h5_test.log