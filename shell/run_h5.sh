...
outD=5
input_dim=7
python save_pred.py /data/suehara/mldata/pfa/murata/neutron_1to100GeV/test checkpoint/energy_regression/ckpts_gravnet_new02_2025_06_30_151610_outputD5/ckpt_444_1.pth.tar h5/test_neutron.h5 0 10 False ${input_dim} ${outD} --energy-regression --energy-regression-cluster --momentum --momentum-amp #> log/h5/test_2025_01_30_161918.log