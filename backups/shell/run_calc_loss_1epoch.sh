...
python calc_train_loss_1epoch.py -i /data/suehara/gravnet_ilc/data/ntau/tc_ntau_10GeV_10/train -ii /data/suehara/gravnet_ilc/data/ntau/tc_ntau_10GeV_10/validation --thetaphi --cuda cuda:${ncuda} --epochs 50 --beta-track --force-track-alpha --batch-size 10 --output-dimension ${outputD} --ckptdir checkpoint/output_dimensions/ckpts_gravnet_new02_${DATE}_outputD${outputD} --epoch-specific ${epoch} > log/output_dimension/calc_loss/tc_ntau_10GeV_10_timingcut_forcealpha_thetaphi_outputD${outputD}_epoch${epoch}.log
