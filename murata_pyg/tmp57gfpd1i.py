...
class Propagate_08f113(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_08f113(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_08f113(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_08f113) -> Collect_08f113
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_08f113) -> Collect_08f113
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_08f113(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_08f113(x=x, edge_weight=edge_weight)
