...
class Propagate_1d5f9a(NamedTuple):
    x: OptPairTensor
    edge_weight: OptTensor



class Collect_1d5f9a(NamedTuple):
    x_j: torch.Tensor
...
class GravNetConvJittable_1d5f9a(GravNetConv):
    ...
    def __collect__(self, edge_def, size, kwargs):
        # type: (Tensor, List[Optional[int]], Propagate_1d5f9a) -> Collect_1d5f9a
        pass

    @torch.jit._overload_method
    def __collect__(self, edge_def, size, kwargs):
        # type: (SparseTensor, List[Optional[int]], Propagate_1d5f9a) -> Collect_1d5f9a
        pass
    ...
    def __collect__(self, edge_def, size, kwargs):
        ...
        return Collect_1d5f9a(x_j=x_j, edge_weight=edge_weight, index=index, dim_size=dim_size)
    ...
    def propagate(self, edge_index, x, edge_weight, size=None):
        ...
        in_kwargs = Propagate_1d5f9a(x=x, edge_weight=edge_weight)
