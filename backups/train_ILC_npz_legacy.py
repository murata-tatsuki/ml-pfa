...
from dataset_ILC_legacy import ILCDataset
...
def main():
    ...
    dataset = ILCDataset(ReadText("Grav_ILC_setting")["Data Folder"])
    #dataset = ILCDataset("/gluster/maxi/ilc/tsumura/npz_retagged_doublePG_0207_1/npz_retagged_doublePG_5_com_rename")
...
#                print(data.x[0], data.y[0])
    ...
    ckpt_dir = strftime('checkpoint/ckpts_gravnet_npz_%b%d_%H%M') if args.ckptdir is None else args.ckptdir
